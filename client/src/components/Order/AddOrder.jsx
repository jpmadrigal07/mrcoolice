...
const AddOrder = (props) => {
  const { triggerTopAlert, iceTypeContent, weightContent, scaleContent, customerList } = props
    ...
    <>
          ...
          <Panel bordered style={{ margin: 10 }}>
            <Form onSubmit={() => handleCreateOrder()}>
              ...
              <FormGroup>
                <ButtonToolbar>
                  <Button appearance="primary" type="submit" style={{ marginRight: 10 }}>Create</Button>
                  <Button appearance="default" onClick={() => handleReset()}>Reset</Button>
                </ButtonToolbar>
              </FormGroup>
            </Form>
          </Panel>
