        ...
        if (isEditActive) {
            if (updateExpense.isSuccess) {
                if (!updateExpense.data?.data?.errors) {
                    ...
                    triggerTopAlert(true, updateExpense.data?.data?.errors[0].message, "danger");
                }
            }
        ...
        if (!isEditActive) {
            if (createExpense.isSuccess) {
                if (!createExpense.data?.data?.errors) {
                    ...
                    triggerTopAlert(true, createExpense.data?.data?.errors[0].message, "danger");
                }
            }
                        ...
                        <ButtonToolbar>
                            {
                                isEditActive ?
                                    ...
                                    :
                                    <Button appearance="primary" type="submit" disabled={createExpense.isLoading}>Add</Button>
                            }
                        </ButtonToolbar>
                    </FormGroup>
                </Form>
